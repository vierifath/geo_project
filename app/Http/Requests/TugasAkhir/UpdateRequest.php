...
class UpdateRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'dosen_penguji_3' => 'required|different:dosen_penguji_2',
            'dosen_penguji_4' => 'required|different:dosen_penguji_1',
            'tanggal_sidang_ta' => 'required',
            'lokasi_sidang_ta' => 'required',
        ];
    }
}
