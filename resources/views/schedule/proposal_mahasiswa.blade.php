    ...
    <div class="row">
        ...
        <div class="col-lg-12 mb-6">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <div>
                        <form action="/sidang/proposal/update" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-md-12">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="dosen_penguji_1" class="form-control form-control-user select2" style="width: 100%;" value="{{ old('dosen_penguji_1') }}">
                                            <option disabled selected>Choose 1st Examiner</option>
                                            @foreach($dosens as $dosen)
                                            <option value="{{ $dosen->id }}" @if ($proposal->dosen_penguji_1_id == $dosen->id) selected @endif>{{ $dosen->nama }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="dosen_penguji_2" class="form-control form-control-user select2" style="width: 100%;" value="{{ old('dosen_penguji_2') }}">
                                            <option disabled selected>Choose 2nd Examiner</option>
                                            @foreach($dosens as $dosen)
                                            <option value="{{ $dosen->id }}" @if ($proposal->dosen_penguji_2_id == $dosen->id) selected @endif>{{ $dosen->nama }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type='text' class="form-control" id='datetimepicker1' name="tanggal_sidang_proposal" value="{{$proposal->tanggal_sidang_proposal}}"/>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Proposal Session Location <span style="color: red; font-size:10px;">* Required</span></label>   
                                        <input type='text' class="form-control" name="lokasi_sidang_proposal" value="{{$proposal->lokasi_sidang_proposal}}"/>
                                    </div>
                                </div>
                            </div>
...
<script type="text/javascript">
    ...
    $("#sidang-proposal").addClass("active");
